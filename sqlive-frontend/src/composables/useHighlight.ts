...
import { extractSqlStatements, compareValuesForHighlight } from '../utils/sqlStatements';
...
export function useHighlight(code: { value: string }, db: DatabaseModel) {
    ...
    function flashCode(sql: string) {
        ...
        setTimeout(() => { highlightedCodeChunk.value = null; }, 1500);
    }
